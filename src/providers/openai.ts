...
export type UsageCallback = (usage: { model: string; inputTokens: number; outputTokens: number; costUsd: number }) => void;
...
function calculateCost(model: string, inputTokens: number, outputTokens: number, isOpenAiCompatible = false): number {
...
export class OpenAIProvider implements LLMProvider {
  ...
  constructor(apiKey: string, model = 'gpt-4o', baseUrl?: string | null, onUsage?: UsageCallback) {
