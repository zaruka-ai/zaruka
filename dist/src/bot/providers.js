...
export const PROVIDER_API_KEY_HINTS = {
...
export const OAUTH_PROVIDERS = new Set(['anthropic', 'openai']);
...
export function settingsProviderKeyboard(currentProvider) {
    const providers = ['anthropic', 'openai', 'google', 'deepseek', 'groq', 'xai', 'openai-compatible'];
    const rows = [];
...
async function testChatGPTConnection(ai) {
...
export function buildRateLimitMessage(provider, isOAuth, errorMsg) {
