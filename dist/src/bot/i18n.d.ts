...
export declare const UI_STRINGS: {
    ...
    readonly 'tasks.title': "📋 Tasks ({count} active)";
    readonly 'tasks.empty': "No tasks yet. Ask me to create one!";
    readonly 'tasks.no_results': "No tasks match this filter.";
    readonly 'tasks.filter_active': "Active";
    readonly 'tasks.filter_completed': "Completed";
    readonly 'tasks.filter_all': "All";
    readonly 'tasks.prev_btn': "« Prev";
    readonly 'tasks.next_btn': "Next »";
    readonly 'tasks.complete_btn': "✅ Complete";
    readonly 'tasks.delete_btn': "🗑 Delete";
    readonly 'tasks.pause_btn': "⏸ Pause";
    readonly 'tasks.resume_btn': "▶️ Resume";
    readonly 'tasks.back_btn': "« Back";
    readonly 'tasks.completed_msg': "✅ Task completed.";
    readonly 'tasks.deleted_msg': "🗑 Task deleted.";
    readonly 'tasks.paused_msg': "⏸ Task paused.";
    readonly 'tasks.resumed_msg': "▶️ Task resumed.";
    readonly 'tasks.not_found': "Task not found.";
    readonly 'cmd_desc.start': "Start the bot";
    readonly 'cmd_desc.settings': "Configure model, language, thresholds";
    readonly 'cmd_desc.tasks': "View and manage tasks";
