...
function localToFakeUtc(dateStr, timeStr) {
...
function nowAsFakeUtc(timezone) {
    const now = new Date();
...
function computeNextOccurrence(recurrence, dueDate, dueTime, timezone) {
    ...
    if (!next)
        return null; // COUNT/UNTIL exhausted
