...
export function createExecuteSkillTool(skillsDir) {
    return tool('execute_dynamic_skill', 'Execute a dynamically created skill tool by name. Use this to call skills that were just created by evolve_skill, '
        ...
        if (!existsSync(skillsDir)) {
            return {
                content: [{ type: 'text', text: JSON.stringify({ error: 'No skills directory found' }) }],
            };
        }
...
//# sourceMappingURL=execute-skill-tool.js.map